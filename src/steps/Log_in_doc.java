...
public class Log_in_doc implements ActionListener {
JFrame window = new JFrame();
	...
	public void initGui() {
		...
		window.setTitle("Doctor's Log in");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==login) {
			...
			File file = new File("D:\\eclipse-workspace\\Project\\src\\steps\\doctor_UserPass.txt");
			try(Scanner in = new Scanner(file);)
			{
				...
				if(usernamefile.equals(username) && passfile.equals(password))
				{
					...
					window.dispose();
					See_Serials_Gui p1 = new See_Serials_Gui();
					p1.initGui();
				}
				}
			}
